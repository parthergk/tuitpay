  ...
  return (
    <section className="relative z-0 flex flex-col bg-[linear-gradient(to_bottom_right,#FFFFFF_0%,#E0ECFF_25%,#EAE2FF_50%,#F8E8DB_75%,#FFFFFF_100%)] text-gray-700">
      ...
      <div className="relative w-full max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-28 sm:py-36 lg:py-44">
        <h1 className="text-heading text-4xl font-bold mb-6">Privacy Policy for Smritya</h1>
        ...
        <div className="space-y-10">
          <div>
            <h2 className="text-heading text-2xl font-semibold mb-3">1. Information We Collect</h2>
          ...
          <div>
            <h2 className="text-heading text-2xl font-semibold mb-3">2. How We Use Information</h2>
            <ul className="list-disc list-inside text-lg leading-relaxed">
          ...
          <div>
            <h2 className="text-heading text-2xl font-semibold mb-3">3. Payment Processing</h2>
          ...
          <div>
            <h2 className="text-heading text-2xl font-semibold mb-3">4. Cookies and Tracking</h2>
            <p className="text-lg leading-relaxed">
          ...
          <div>
            <h2 className="text-heading text-2xl font-semibold mb-3">5. Data Security</h2>
            <p className="text-lg leading-relaxed">
          ...
          <div>
            <h2 className="text-heading text-2xl font-semibold mb-3">6. Data Sharing</h2>
            <p className="text-lg leading-relaxed">
          ...
          <div>
            <h2 className="text-heading text-2xl font-semibold mb-3">7. User Rights</h2>
            <p className="text-lg leading-relaxed">
          ...
          <div>
            <h2 className="text-heading text-2xl font-semibold mb-3">8. Children’s Privacy</h2>
            <p className="text-lg leading-relaxed">
          ...
          <div>
            <h2 className="text-heading text-2xl font-semibold mb-3">9. Changes to This Policy</h2>
            <p className="text-lg leading-relaxed">
          ...
          <div>
            <h2 className="text-heading text-2xl font-semibold mb-3">10. Contact</h2>
            <p className="text-lg leading-relaxed">
