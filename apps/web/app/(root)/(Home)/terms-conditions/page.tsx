    ...
    <section className="relative z-0 flex flex-col bg-[linear-gradient(to_bottom_right,#FFFFFF_0%,#E0ECFF_25%,#EAE2FF_50%,#F8E8DB_75%,#FFFFFF_100%)] text-gray-700">
      ...
      <div className="relative w-full max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-28 sm:py-36 lg:py-44">
        ...
        <div className="space-y-10">
          ...
          <div>
            <h2 className="text-heading text-2xl mb-3">3. Account Registration</h2>
            <p className="text-base leading-relaxed">
          ...
          <div>
            <h2 className="text-heading text-2xl mb-3">5. Payments and Subscription</h2>
          ...
          <div>
            <h2 className="text-heading text-2xl mb-3">6. Acceptable Use</h2>
            <p className="text-base leading-relaxed">
          ...
          <div>
            <h2 className="text-heading text-2xl mb-3">9. Termination</h2>
            <p className="text-base leading-relaxed">
          ...
          <div>
            <h2 className="text-heading text-2xl mb-3">11. Governing Law</h2>
            <p className="text-base leading-relaxed">These terms are governed by <strong>Indian Law</strong>.</p>
          </div>
