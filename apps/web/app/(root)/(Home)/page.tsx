  ...
  return (
    <div className="absolute inset-0 z-0 px-5 w-full flex justify-center items-center bg-[linear-gradient(to_bottom_right,#FFFFFF_0%,#E0ECFF_25%,#EAE2FF_50%,#F8E8DB_75%,#FFFFFF_100%)]">
      <div className="w-full max-w-4xl mx-auto text-center">
        ...
        <p className="mt-4 text-base sm:text-lg md:text-xl text-[#4B5563] max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 mt-8">
          <button className="w-full sm:w-auto px-5 py-1.5 sm:px-6 sm:py-2 rounded-full bg-[#F97316] text-white font-medium shadow-md hover:bg-[#ea580c] transition-colors duration-200">
            Get Started
          </button>
          <button className="w-full sm:w-auto px-5 py-1.5 sm:px-6 sm:py-2 rounded-full border border-[#6B7280] text-[#374151] hover:bg-[#f9fafb] transition-colors duration-200">
            How it Works
          </button>
        </div>
