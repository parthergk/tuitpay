...
const Resend = () => {
  ...
  return (
    <div className="max-w-md m-auto p-6 flex flex-col mt-16">
      ...
      <div className="w-full flex gap-2 items-center justify-center py-2 px-4 mt-5 mb-2 rounded-md text-base md:text-lg text-[#4B5563] bg-gradient-to-bl from-[#E8DFFF]/30 to-[#DDEBFF]/30 shadow-xl shadow-black/10 border border-white/50 hover:scale-[1.02] transition-transform">
        <MailWarning className=" self-start" />
        <span>
          You need to verify your email address to activate your account.
        </span>
      </div>
      <span className="my-3 text-base md:text-lg text-[#4B5563]">
